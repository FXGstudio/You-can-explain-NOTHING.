...
import net.mcbbs.youcanexplainnothing.item.TourmalineGemItem;
...
public class TourmalineOreBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tourmaline_ore")
	public static final Block block = null;
	public TourmalineOreBlock(YouCanExplainNothingModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tourmaline_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TourmalineGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tourmaline_ore", "tourmaline_ore", blockAt -> {
