...
public class BlockGumSlab extends ElementsYouCanExplainNothingMod.ModElement {
	@GameRegistry.ObjectHolder("you_can_explain_nothing:gum_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("you_can_explain_nothing:gum_slab_double")
	public static final Block block_slab_double = null;
	public BlockGumSlab(ElementsYouCanExplainNothingMod instance) {
		super(instance, 143);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gum_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("gum_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("you_can_explain_nothing:gum_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("gum_slab");
