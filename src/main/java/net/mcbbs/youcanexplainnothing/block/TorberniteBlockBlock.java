...
public class TorberniteBlockBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:torbernite_block")
	public static final Block block = null;
	public TorberniteBlockBlock(YouCanExplainNothingModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("torbernite_block");
		}
