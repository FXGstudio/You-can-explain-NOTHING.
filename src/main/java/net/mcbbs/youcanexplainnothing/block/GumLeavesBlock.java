...
public class GumLeavesBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_leaves")
	public static final Block block = null;
	public GumLeavesBlock(YouCanExplainNothingModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0.2f).lightValue(0));
			setRegistryName("gum_leaves");
		}
