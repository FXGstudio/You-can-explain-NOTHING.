...
public class GumSlabBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_slab")
	public static final Block block = null;
	public GumSlabBlock(YouCanExplainNothingModElements instance) {
		super(instance, 143);
	}
