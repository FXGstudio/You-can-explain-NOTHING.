...
public class GumLogBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_log")
	public static final Block block = null;
	public GumLogBlock(YouCanExplainNothingModElements instance) {
		super(instance, 139);
	}
