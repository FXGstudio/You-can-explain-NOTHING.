...
public class MachineCasingSimpleBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:machine_casing_simple")
	public static final Block block = null;
	public MachineCasingSimpleBlock(YouCanExplainNothingModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("machine_casing_simple");
		}
