...
public class GumWoodBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_wood")
	public static final Block block = null;
	public GumWoodBlock(YouCanExplainNothingModElements instance) {
		super(instance, 138);
	}
