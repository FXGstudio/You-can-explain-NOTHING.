...
public class ZincOreBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:zinc_ore")
	public static final Block block = null;
	public ZincOreBlock(YouCanExplainNothingModElements instance) {
		super(instance, 226);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 4f).lightValue(0).harvestLevel(1)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5), Placement.COUNT_RANGE, new CountRangeConfig(8, 1, 1, 49)));
		}
	}
}
