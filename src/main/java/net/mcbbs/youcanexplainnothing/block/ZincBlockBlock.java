...
public class ZincBlockBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:zinc_block")
	public static final Block block = null;
	public ZincBlockBlock(YouCanExplainNothingModElements instance) {
		super(instance, 227);
	}
