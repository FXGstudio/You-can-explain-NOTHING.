...
public class TinOreBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tin_ore")
	public static final Block block = null;
	public TinOreBlock(YouCanExplainNothingModElements instance) {
		super(instance, 200);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tin_ore", "tin_ore", blockAt -> {
