...
public class GumStairsBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_stairs")
	public static final Block block = null;
	public GumStairsBlock(YouCanExplainNothingModElements instance) {
		super(instance, 142);
	}
