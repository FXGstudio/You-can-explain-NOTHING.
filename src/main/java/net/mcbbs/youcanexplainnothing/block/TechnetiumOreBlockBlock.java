...
public class TechnetiumOreBlockBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:technetium_ore_block")
	public static final Block block = null;
	public TechnetiumOreBlockBlock(YouCanExplainNothingModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("technetium_ore_block");
		}
