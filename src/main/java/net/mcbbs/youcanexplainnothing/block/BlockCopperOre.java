...
public class BlockCopperOre extends ElementsYouCanExplainNothingMod.ModElement {
	@GameRegistry.ObjectHolder("you_can_explain_nothing:copper_ore")
	public static final Block block = null;
	public BlockCopperOre(ElementsYouCanExplainNothingMod instance) {
		super(instance, 37);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("you_can_explain_nothing:copper_ore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setHardness(2.25F);
			setResistance(3.9720894039330457F);
			setLightLevel(0F);
			setLightOpacity(255);
