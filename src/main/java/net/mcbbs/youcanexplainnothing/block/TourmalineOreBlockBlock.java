...
public class TourmalineOreBlockBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tourmaline_ore_block")
	public static final Block block = null;
	public TourmalineOreBlockBlock(YouCanExplainNothingModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tourmaline_ore_block");
		}
