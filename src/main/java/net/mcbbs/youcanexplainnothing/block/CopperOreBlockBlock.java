...
public class CopperOreBlockBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:copper_ore_block")
	public static final Block block = null;
	public CopperOreBlockBlock(YouCanExplainNothingModElements instance) {
		super(instance, 38);
	}
