...
public class CopperOreBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(YouCanExplainNothingModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.25f, 3.9720894039330457f).lightValue(0)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 9), Placement.COUNT_RANGE, new CountRangeConfig(14, 1, 1, 81)));
		}
	}
}
