...
public class GumFenceGateBlock extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gum_fence_gate")
	public static final Block block = null;
	public GumFenceGateBlock(YouCanExplainNothingModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("gum_fence_gate");
		}
