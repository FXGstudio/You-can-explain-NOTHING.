...
public class GuiSoundFromSilenceGUI extends ElementsYouCanExplainNothingMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiSoundFromSilenceGUI(ElementsYouCanExplainNothingMod instance) {
		super(instance, 58);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 8, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemAncientDust.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 46, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemLightning.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 134, 43) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("you_can_explain_nothing:textures/sound_from_silence_gui.png");
		@Override
