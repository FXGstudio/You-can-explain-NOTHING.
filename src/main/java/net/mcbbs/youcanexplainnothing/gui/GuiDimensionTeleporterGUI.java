...
import net.mcbbs.youcanexplainnothing.procedure.ProcedureGODT;
...
public class GuiDimensionTeleporterGUI extends ElementsYouCanExplainNothingMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiDimensionTeleporterGUI(ElementsYouCanExplainNothingMod instance) {
		super(instance, 89);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 80, 13) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemEvilEnergyUnit.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 79, 38) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 78, this.guiTop + 60, 20, 20, "GO"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGODT.executeProcedure($_dependencies);
			}
		}
	}
