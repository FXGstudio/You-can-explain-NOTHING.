...
public class GuiEvilGeneratorGUI extends ElementsYouCanExplainNothingMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiEvilGeneratorGUI(ElementsYouCanExplainNothingMod instance) {
		super(instance, 209);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 81, 20) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("you_can_explain_nothing:textures/evil_generator_gui.png");
		@Override
