...
public class GuiGrinderSimpleGUI extends ElementsYouCanExplainNothingMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiGrinderSimpleGUI(ElementsYouCanExplainNothingMod instance) {
		super(instance, 199);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 79, 13) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 79, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 56, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 102, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 139, 20) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemEvilEnergyUnit.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("you_can_explain_nothing:textures/grinder_simple_gui.png");
		@Override
