...
public class BrassDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:brass_dust")
	public static final Item block = null;
	public BrassDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 234);
	}
