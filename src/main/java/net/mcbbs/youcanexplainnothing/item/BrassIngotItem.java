...
public class BrassIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:brass_ingot")
	public static final Item block = null;
	public BrassIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 239);
	}
