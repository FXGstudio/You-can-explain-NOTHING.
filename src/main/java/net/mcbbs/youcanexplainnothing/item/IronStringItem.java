...
public class IronStringItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:iron_string")
	public static final Item block = null;
	public IronStringItem(YouCanExplainNothingModElements instance) {
		super(instance, 164);
	}
