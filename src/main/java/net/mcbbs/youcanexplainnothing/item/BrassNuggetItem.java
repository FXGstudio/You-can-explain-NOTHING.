...
public class BrassNuggetItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:brass_nugget")
	public static final Item block = null;
	public BrassNuggetItem(YouCanExplainNothingModElements instance) {
		super(instance, 237);
	}
