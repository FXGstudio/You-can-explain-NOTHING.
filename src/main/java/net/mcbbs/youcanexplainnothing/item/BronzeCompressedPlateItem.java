...
public class BronzeCompressedPlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_compressed_plate")
	public static final Item block = null;
	public BronzeCompressedPlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 248);
	}
