...
public class StoneRingItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_ring")
	public static final Item block = null;
	public StoneRingItem(YouCanExplainNothingModElements instance) {
		super(instance, 135);
	}
