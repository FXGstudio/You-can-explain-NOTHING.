...
public class LapisLazuliCapacitorItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:lapis_lazuli_capacitor")
	public static final Item block = null;
	public LapisLazuliCapacitorItem(YouCanExplainNothingModElements instance) {
		super(instance, 231);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lapis_lazuli_capacitor");
		}
