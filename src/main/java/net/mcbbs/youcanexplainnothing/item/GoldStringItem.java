...
public class GoldStringItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:gold_string")
	public static final Item block = null;
	public GoldStringItem(YouCanExplainNothingModElements instance) {
		super(instance, 163);
	}
