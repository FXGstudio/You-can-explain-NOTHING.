...
public class BronzeHammerItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_hammer")
	public static final Item block = null;
	public BronzeHammerItem(YouCanExplainNothingModElements instance) {
		super(instance, 224);
	}
