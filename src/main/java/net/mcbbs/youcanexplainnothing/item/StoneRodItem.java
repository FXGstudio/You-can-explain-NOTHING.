...
public class StoneRodItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_rod")
	public static final Item block = null;
	public StoneRodItem(YouCanExplainNothingModElements instance) {
		super(instance, 191);
	}
