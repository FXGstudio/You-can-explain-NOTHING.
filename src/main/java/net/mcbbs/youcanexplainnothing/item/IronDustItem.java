...
public class IronDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:iron_dust")
	public static final Item block = null;
	public IronDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 211);
	}
