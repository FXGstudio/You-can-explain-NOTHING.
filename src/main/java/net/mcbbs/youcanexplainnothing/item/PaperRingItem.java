...
public class PaperRingItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:paper_ring")
	public static final Item block = null;
	public PaperRingItem(YouCanExplainNothingModElements instance) {
		super(instance, 172);
	}
