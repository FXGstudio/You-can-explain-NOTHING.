...
public class FilterItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:filter")
	public static final Item block = null;
	public FilterItem(YouCanExplainNothingModElements instance) {
		super(instance, 195);
	}
