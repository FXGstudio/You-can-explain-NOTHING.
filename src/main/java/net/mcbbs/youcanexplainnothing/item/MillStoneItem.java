...
public class MillStoneItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:mill_stone")
	public static final Item block = null;
	public MillStoneItem(YouCanExplainNothingModElements instance) {
		super(instance, 193);
	}
