...
public class TechnetiumDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:technetium_dust")
	public static final Item block = null;
	public TechnetiumDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 212);
	}
