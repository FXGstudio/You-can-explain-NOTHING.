...
import net.mcbbs.youcanexplainnothing.gui.CommandWandGUIGui;
...
public class CommandWandItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:command_wand")
	public static final Item block = null;
	public CommandWandItem(YouCanExplainNothingModElements instance) {
		super(instance, 28);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CommandWandGUIGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(NothingSurfaceItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("command_wand");
		}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "item_damage", (double) 114513, AttributeModifier.Operation.ADDITION));
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Command Wand");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CommandWandGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
