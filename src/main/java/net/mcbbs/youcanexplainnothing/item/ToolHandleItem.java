...
public class ToolHandleItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tool_handle")
	public static final Item block = null;
	public ToolHandleItem(YouCanExplainNothingModElements instance) {
		super(instance, 127);
	}
