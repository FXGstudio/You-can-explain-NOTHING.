...
public class StoneKnifeItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_knife")
	public static final Item block = null;
	public StoneKnifeItem(YouCanExplainNothingModElements instance) {
		super(instance, 125);
	}
	...
	public void initElements() {
		...
		}, 3, 1f, new Item.Properties().group(NothingSurfaceItemGroup.tab)) {
			@Override
