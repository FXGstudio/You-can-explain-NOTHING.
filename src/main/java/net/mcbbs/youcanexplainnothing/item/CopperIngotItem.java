...
public class CopperIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 36);
	}
