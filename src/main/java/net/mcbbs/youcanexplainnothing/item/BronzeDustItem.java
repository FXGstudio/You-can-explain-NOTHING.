...
public class BronzeDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_dust")
	public static final Item block = null;
	public BronzeDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 215);
	}
