...
public class BrassDoubleIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:brass_double_ingot")
	public static final Item block = null;
	public BrassDoubleIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 247);
	}
