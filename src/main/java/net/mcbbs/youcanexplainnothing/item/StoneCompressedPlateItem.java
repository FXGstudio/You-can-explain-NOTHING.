...
public class StoneCompressedPlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_compressed_plate")
	public static final Item block = null;
	public StoneCompressedPlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 134);
	}
