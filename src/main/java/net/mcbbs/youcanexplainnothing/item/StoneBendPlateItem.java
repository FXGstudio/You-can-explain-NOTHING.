...
public class StoneBendPlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_bend_plate")
	public static final Item block = null;
	public StoneBendPlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 131);
	}
