...
public class LightningItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:lightning")
	public static final Item block = null;
	public LightningItem(YouCanExplainNothingModElements instance) {
		super(instance, 57);
	}
