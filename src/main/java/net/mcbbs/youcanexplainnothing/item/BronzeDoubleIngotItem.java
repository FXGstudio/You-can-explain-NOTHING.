...
public class BronzeDoubleIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_double_ingot")
	public static final Item block = null;
	public BronzeDoubleIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 246);
	}
