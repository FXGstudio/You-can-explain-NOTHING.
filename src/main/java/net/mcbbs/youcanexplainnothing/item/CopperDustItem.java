...
public class CopperDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:copper_dust")
	public static final Item block = null;
	public CopperDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 214);
	}
