...
public class TourmalineGemItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tourmaline_gem")
	public static final Item block = null;
	public TourmalineGemItem(YouCanExplainNothingModElements instance) {
		super(instance, 1);
	}
