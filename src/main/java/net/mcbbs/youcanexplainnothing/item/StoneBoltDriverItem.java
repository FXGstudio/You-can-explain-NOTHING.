...
public class StoneBoltDriverItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_bolt_driver")
	public static final Item block = null;
	public StoneBoltDriverItem(YouCanExplainNothingModElements instance) {
		super(instance, 124);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("stone_bolt_driver"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(NothingSurfaceItemGroup.tab).maxDamage(100));
		}
