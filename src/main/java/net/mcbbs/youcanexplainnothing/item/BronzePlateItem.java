...
public class BronzePlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_plate")
	public static final Item block = null;
	public BronzePlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 243);
	}
