...
public class WorldCoreItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:world_core")
	public static final Item block = null;
	public WorldCoreItem(YouCanExplainNothingModElements instance) {
		super(instance, 87);
	}
