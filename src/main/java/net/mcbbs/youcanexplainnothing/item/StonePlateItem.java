...
public class StonePlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_plate")
	public static final Item block = null;
	public StonePlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 130);
	}
