...
public class TinStringItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:tin_string")
	public static final Item block = null;
	public TinStringItem(YouCanExplainNothingModElements instance) {
		super(instance, 205);
	}
