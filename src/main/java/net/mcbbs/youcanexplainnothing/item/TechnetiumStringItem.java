...
public class TechnetiumStringItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:technetium_string")
	public static final Item block = null;
	public TechnetiumStringItem(YouCanExplainNothingModElements instance) {
		super(instance, 165);
	}
