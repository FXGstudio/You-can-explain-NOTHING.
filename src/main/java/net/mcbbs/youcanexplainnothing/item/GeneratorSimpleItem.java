...
public class GeneratorSimpleItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:generator_simple")
	public static final Item block = null;
	public GeneratorSimpleItem(YouCanExplainNothingModElements instance) {
		super(instance, 206);
	}
