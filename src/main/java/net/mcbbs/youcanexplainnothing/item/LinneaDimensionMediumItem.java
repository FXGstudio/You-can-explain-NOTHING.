...
public class LinneaDimensionMediumItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:linnea_dimension_medium")
	public static final Item block = null;
	public LinneaDimensionMediumItem(YouCanExplainNothingModElements instance) {
		super(instance, 69);
	}
