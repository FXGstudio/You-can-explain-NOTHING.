...
public class BronzeIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:bronze_ingot")
	public static final Item block = null;
	public BronzeIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 217);
	}
