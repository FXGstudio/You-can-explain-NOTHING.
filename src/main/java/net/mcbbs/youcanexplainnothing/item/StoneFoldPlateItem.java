...
public class StoneFoldPlateItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_fold_plate")
	public static final Item block = null;
	public StoneFoldPlateItem(YouCanExplainNothingModElements instance) {
		super(instance, 132);
	}
