...
public class CopperStringItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:copper_string")
	public static final Item block = null;
	public CopperStringItem(YouCanExplainNothingModElements instance) {
		super(instance, 160);
	}
