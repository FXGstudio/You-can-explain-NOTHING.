...
public class StoneHammerItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_hammer")
	public static final Item block = null;
	public StoneHammerItem(YouCanExplainNothingModElements instance) {
		super(instance, 118);
	}
	...
	public void initElements() {
		...
		}, 1, -3f, new Item.Properties().group(NothingSurfaceItemGroup.tab)) {
			@Override
