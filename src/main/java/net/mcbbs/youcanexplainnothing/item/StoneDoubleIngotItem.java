...
public class StoneDoubleIngotItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:stone_double_ingot")
	public static final Item block = null;
	public StoneDoubleIngotItem(YouCanExplainNothingModElements instance) {
		super(instance, 133);
	}
