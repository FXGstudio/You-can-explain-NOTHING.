...
public class ZincDustItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:zinc_dust")
	public static final Item block = null;
	public ZincDustItem(YouCanExplainNothingModElements instance) {
		super(instance, 235);
	}
