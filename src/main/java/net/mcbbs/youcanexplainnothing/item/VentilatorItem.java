...
public class VentilatorItem extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:ventilator")
	public static final Item block = null;
	public VentilatorItem(YouCanExplainNothingModElements instance) {
		super(instance, 186);
	}
