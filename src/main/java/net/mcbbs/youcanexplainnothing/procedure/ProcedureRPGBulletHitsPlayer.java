...
public class ProcedureRPGBulletHitsPlayer extends ElementsYouCanExplainNothingMod.ModElement {
	public ProcedureRPGBulletHitsPlayer(ElementsYouCanExplainNothingMod instance) {
		super(instance, 26);
	}
