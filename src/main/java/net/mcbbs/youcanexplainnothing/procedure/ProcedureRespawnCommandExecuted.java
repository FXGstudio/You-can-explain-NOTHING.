...
public class ProcedureRespawnCommandExecuted extends ElementsYouCanExplainNothingMod.ModElement {
	public ProcedureRespawnCommandExecuted(ElementsYouCanExplainNothingMod instance) {
		super(instance, 91);
	}
