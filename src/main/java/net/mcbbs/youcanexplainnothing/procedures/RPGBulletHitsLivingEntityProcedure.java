...
public class RPGBulletHitsLivingEntityProcedure extends YouCanExplainNothingModElements.ModElement {
	public RPGBulletHitsLivingEntityProcedure(YouCanExplainNothingModElements instance) {
		super(instance, 25);
	}
