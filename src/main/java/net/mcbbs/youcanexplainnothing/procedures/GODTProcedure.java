...
import net.mcbbs.youcanexplainnothing.world.dimension.LinneaDimension;
import net.mcbbs.youcanexplainnothing.item.NetherDimensionMediumItem;
import net.mcbbs.youcanexplainnothing.item.LinneaDimensionMediumItem;
import net.mcbbs.youcanexplainnothing.item.EndDimensionMediumItem;
...
public class GODTProcedure extends YouCanExplainNothingModElements.ModElement {
	public GODTProcedure(YouCanExplainNothingModElements instance) {
		super(instance, 89);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(NetherDimensionMediumItem.block, (int) (1))
					.getItem())) {
				{
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(EndDimensionMediumItem.block, (int) (1))
					.getItem())) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
			...
			if (((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(LinneaDimensionMediumItem.block, (int) (1))
					.getItem())) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
				...
				}
				{
					Entity _ent = entity;
					if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
						DimensionType destinationType = LinneaDimension.type;
						ObfuscationReflectionHelper.setPrivateValue(ServerPlayerEntity.class, (ServerPlayerEntity) _ent, true, "field_184851_cj");
						ServerWorld nextWorld = _ent.getServer().getWorld(destinationType);
						((ServerPlayerEntity) _ent).connection.sendPacket(new SChangeGameStatePacket(4, 0));
						((ServerPlayerEntity) _ent).teleport(nextWorld, nextWorld.getSpawnPoint().getX(), nextWorld.getSpawnPoint().getY() + 1,
