...
public class RespawnCommandExecutedProcedure extends YouCanExplainNothingModElements.ModElement {
	public RespawnCommandExecutedProcedure(YouCanExplainNothingModElements instance) {
		super(instance, 91);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure RespawnCommandExecuted!");
			return;
		}
