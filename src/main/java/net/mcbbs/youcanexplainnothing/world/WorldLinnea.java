...
package net.mcbbs.youcanexplainnothing.world;
...
import net.mcbbs.youcanexplainnothing.block.BlockUnexpectedFluid;
...
public class WorldLinnea extends ElementsYouCanExplainNothingMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldLinnea(ElementsYouCanExplainNothingMod instance) {
		super(instance, 64);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension linnea is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("linnea", "_linnea", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockPaperBlock.block.getDefaultState();
		private static final IBlockState STONE2 = BlockPaperBlock.block.getDefaultState();
		private static final IBlockState FLUID = BlockUnexpectedFluid.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("you_can_explain_nothing:linnea_biome")),
