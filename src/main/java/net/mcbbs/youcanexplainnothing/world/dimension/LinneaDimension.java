...
package net.mcbbs.youcanexplainnothing.world.dimension;
...
import net.mcbbs.youcanexplainnothing.block.UnexpectedFluidBlock;
...
public class LinneaDimension extends YouCanExplainNothingModElements.ModElement {
	@ObjectHolder("you_can_explain_nothing:linnea")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public LinneaDimension(YouCanExplainNothingModElements instance) {
		super(instance, 64);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("linnea"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("you_can_explain_nothing:linnea")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("you_can_explain_nothing:linnea"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("you_can_explain_nothing:linnea"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("you_can_explain_nothing:linnea_biome")),
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return PaperBlockBlock.block.getDefaultState();
				}

				public BlockState getDefaultFluid() {
					return UnexpectedFluidBlock.block.getDefaultState();
				}
			});
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(PaperBlockBlock.block.getDefaultState().getBlock(),
